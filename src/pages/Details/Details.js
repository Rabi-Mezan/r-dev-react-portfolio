...
const Details = () => {
    return (
        <div style={{ backgroundColor: '#111111' }} className='min-h-screen lg:flex  items-center justify-around'>
            <h1 className='lg:text-5xl text-center font-bold text-white py-10'>PROJECT DETAILS  <span style={{ color: '#FFB400' }} className=' font-extrabold text-white'> <br /> COMING SOON !</span>
            </h1>
            <div>
                <div
