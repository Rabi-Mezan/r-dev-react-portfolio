...
const Landing = () => {
    ...
    return (
        <>
            ...
            <div className='pb-10' style={{ backgroundColor: '#111111' }}>
                ...
                <div className="banner-page  h-screen">
                    ...
                    <div
                        ...
                        data-aos-easing="ease-in"
                        style={{ width: '430px' }} className=' flex flex-col lg:justify-item-start justify-center'>
                        <h1 className='intro lg:text-5xl text-md lg:text-left font-bold text-white my-2'>HI I'M<br />
                    ...
                    <div
                        className=' flex mb-5 order-first lg:order-last  flex-col justify-around items-center shadow-md '>
